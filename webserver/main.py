...
def web_page():
    ...
    html = """
            <html>
            <head>
            <title>(CALIFICACION MANUAL) 3.2 Pico W, Webserver con 3 sensores y animación UIX</title>
            ...
            <body>
                <h1>(CALIFICACION MANUAL) 3.2 Pico W, Webserver con 3 sensores y animación UIX</h1>
                <p>RGB Control</p>    
